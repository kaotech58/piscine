...
//extern char	*ft_strstr(char *str, char *to_find); // ex04
//extern unsigned int	ft_strlcat(char *dest, char *src, unsigned int size); // ex05
...
//	ex04:
//	printf("-------------------------------\nex04:	ft_strstr\n-------------------------------\nExpected output:	ghijklghi\nActual output:		%s\n\n", ft_strstr(string1, "ghi"));

//	ex05:
//	printf("-------------------------------\nex05:	ft_strlcat\n-------------------------------\nExpected output:	18	abcdefghijklghighi\nActual output:		%u	%s\n\n", ft_strlcat(string1, string2, 3), string1);
}
